...
namespace VisualObjects.WebService
{
  ...
  public class Service : StatelessService
  {
    ...
    {
      ServiceEventSource.Current.Message("VisualObjects.WebService: CREATE");
    ...
    ~Service()
    {
      ServiceEventSource.Current.Message("VisualObjects.WebService: DESTROY");
    }
    ...
    {
      ServiceEventSource.Current.Message("VisualObjects.WebService: RUN");
    ...
    {
      ServiceEventSource.Current.Message("VisualObjects.WebService: ABORT");
      base.OnAbort();
    }
  }
}