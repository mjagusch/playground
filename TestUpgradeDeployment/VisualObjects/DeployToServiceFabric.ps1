## NOTE DO NOT MODIFY USED ONLY ON OCTO DEPLOY ON NON-LOCAL CLUSTERS
...
.PARAMETER CPUNodeType
This is the name of the CPU node type. The default value is CPUNodeType
...
Write-Host("ConstrainedNodeTypes: "+$ConstrainedNodeTypes);
Write-Host("CPUNodeType: "+$CPUNodeType);
